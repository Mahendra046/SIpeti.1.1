    ...
    <div class="row mt-5">
        <div class="col-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ url('pegawai/pengajuan/cuti-sakit', $pengajuan->id) }}" method="post">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"  value="{{ $pengajuan->alamat_selama_cuti }}" name="alamat_selama_cuti" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="sampai_tanggal" class="form-control"
                                        value="{{ $pengajuan->sampai_tanggal }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="keterangan" class="form-control" id="" cols="30" rows="10">{{$pengajuan->keterangan}}</textarea>
                                </div>
                            </div>
                        </div>
